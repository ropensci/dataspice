...
```{r, echo=FALSE}
readr::read_csv(system.file("metadata-tables/attributes_prepped.csv", package = "dataspice")) %>% kable()
```
...
```{r, echo=FALSE, message=FALSE}
readr::read_csv(system.file("metadata-tables/attributes.csv", package = "dataspice")) %>% kable()
```

```{r, echo=FALSE, message=FALSE}
readr::read_csv(system.file("metadata-tables/biblio.csv", package = "dataspice")) %>% kable()
```
